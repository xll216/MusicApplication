...
public interface AppRetrofitModel {
    void getHotGeDanAndOfficial(Subscriber<GetHotGeDanAndOfficialBean> subscriber);

    void billCategory(Subscriber<BillCategoryBean> subscriber);

    void getGeDanList(Subscriber<GeDanBean> subscriber);

    void getGeDanInfo(int id, Subscriber<GeDanInfoBean> subscriber);
}
